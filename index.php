...
<body>
    <nav>
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-4">
            <img src="playground.jpg" class="welcome_img">
          </div>
           <div class="col-md-8">
            <h1>Welcome to W-school</h1>
            <p>MEMS has been committed to global learning long
                before it became an indispensable feature of
                contemporary education. Established in 1997, we
                proudly stand as the 1st English medium school in
                 Bangladesh to adopt both Pearson Edexcel and
                Cambridge curriculum (in O and A levels), drawing together students in a vibrant, academically challenging, and encouraging environment where manifold viewpoints are prized and celebrated.MEMS has been committed to global learning long before it became an indispensable feature of contemporary education. Established in 1997, we proudly stand as the 1st English medium school in Bangladesh to adopt both Pearson Edexcel and Cambridge curriculum (in O and A levels), drawing together students in a vibrant, academically challenging, and encouraging environment where manifold viewpoints are prized and celebrated.</p>
            </div>
     </div>
    </div> 
    <center>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="web_development.png" class="teacher">
                <h3>Web Development</h3>

                       </div>
            <div class="col-md-4" >
                <img src="digital_marketing.png" class="teacher">
                <h3>Marketing</h3>
               </div>
            <div class="col-md-4">
                <img src="graphic_design.png" class="teacher">
